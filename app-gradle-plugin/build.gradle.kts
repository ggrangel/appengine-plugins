...
version = "2.8.1-SNAPSHOT" // {x-version-update:app-gradle-plugin:current}
...
dependencies {
  ...
  api("com.google.cloud.tools:appengine-plugins-core:0.13.1-SNAPSHOT") // {x-version-update:appengine-plugins-core:current}
